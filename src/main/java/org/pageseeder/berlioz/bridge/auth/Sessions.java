...
public final class Sessions {
   ...
   */
  public static final String USER_ATTRIBUTE = "org.pageseeder.berlioz.bridge.auth.User";

  /**
   * The name of the attribute that contains the request to a protected resource.
   */
  public static final String REQUEST_ATTRIBUTE = "org.pageseeder.berlioz.bridge.auth.HttpRequest";
